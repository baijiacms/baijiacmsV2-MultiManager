...
<title> <?php  echo empty($settings['shop_title'])?'百家cms-多商户管理平台':$settings['shop_title'];?></title>
...
<body>
		<form method='post' target="_parent" name="login" id="login-form" action="<?php  echo mobile_url('login',array('name'=>'user'))?>">
	<div class="login">
		<a href="/" class="logo"></a>
		<div class="login-inner">
			<h1 class="login-title">多商户管理平台</h1>
			...
			<div class="mgb20">
					<img id="verifyimg" onClick="fleshVerify()"  alt="点击切换" src="<?php  echo mobile_url('verify',array('name'=>'user'))?>" style="cursor:pointer;width:265px;height:70px"/>
			</div>
